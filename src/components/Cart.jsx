  ...
  return (
    <div className="cursor-pointer text-zinc-700" onClick={() => dispatch(handeleBasketShow())}>
      <div className="z-10 block relative">
        ...
        {quantity ? <span className="absolute top-0 right-0 mr-1 mt-1 bg-red-500 lg:px-[9px] lg:py-1 px-2 py-[2px] rounded-full text-white font-medium text-xs">{quantity}</span> : <span className="absolute top-0 mr-1 mt-1 right-0 bg-red-500 px-2 py-1 rounded-full text-white text-xs">0</span>}
