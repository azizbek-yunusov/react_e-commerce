  ...
  return (
    <div className="lg:mx-4 mx-1 selection:inset-0 lg:my-4 my-1 border-r border border-gray-200 hover:border-gray-50 rounded-xl hover:shadow-xl transition ease-in-out duration-300">
      <div className="relative flex flex-col pt-1 px-3 pb-3">
        ...
        <div className="absolute top-2 left-2 text-yellow-500 rounded-md text-sm px-[5px] py-[2px] pb-[4px] bg-slate-900 font-normal">
          Лучшая цена
        </div>
        <Link
        ...
        >
          <img src={imgUrl[0]} alt={title} className="align-middle mt-0" />
        </Link>

        <h1 className="float-left mt-2 font-sans text-md">{title}</h1>
