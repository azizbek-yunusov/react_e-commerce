    ...
    <div className="bg-zinc-800 pt-5 overflow-hidden">
      <div className="container-full lg:py-9 py-0">
        ...
        <div className="socials">
          <div className="grid lg:grid-cols-4 grid-cols-1 lg:gap-10">
            <div className="grid grid-cols-2 gap-5">
              <div className="block text-white">
                ...
                <div className="block w-full">
                  ...
                  <p className="text-white text mt-2 font-medium">
                    +998 (94) 554 55 94
                  </p>
                </div>
              </div>
            ...
            <div className="block">
              <h1 className="text-red-600 text-xl lg:mt-0 mt-2 font-semibold">
                Информация
              </h1>
              <p className="text-white text-base cursor-pointer mt-3">
                О компании
              </p>
              <p className="text-white text-base cursor-pointer mt-2">
                Вакансии
              </p>
              <p className="text-white text-base cursor-pointer mt-3">
                Публичная оферта
            ...
            <div className="block mt-10">
              ...
              <h1 className="text-white text-base cursor-pointer font-semibold mt-9">
                Контакты
              </h1>
              <p className="text-white text-base cursor-pointer font-semibold mt-3">
                Info@olcha.uz
      ...
      <div className="border-t border-t-zinc-900 lg:py-5 pb-20 py-3 mt-4 flex justify-center flex-col items-center">
        ...
        <a
          ...
          className="text-lg text-white hover:underline hover:text-blue-600"
        >
          Azizbek Yunusov
        </a>
      </div>
