...
export const CatalogItem = ({id, category, title, imgUrl}) => {
  return (
    <Link to={`/category/${category}`}>
      <div className="cursor-pointer lg:my-8 my-5 flex lg:mx-3 items-center justify-around lg:flex-row flex-col lg:py-10 lg:h-16 h-28   lg:bg-gray-100 rounded-lg">
