...
const CatalogBtn = () => {
  ...
  return (
    <div onClick={() => dispatch(handleSideBar())} className="px-5 hidden  py-[10px] rounded-lg cursor-pointer bg-yellow-400 active:opacity-75 transition-opacity text-zinc-80000 lg:flex">
