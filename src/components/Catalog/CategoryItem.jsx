...
const CategoryItem = ({id, title, price, imgUrl}) => {
  ...
  return (
    <div className="lg:mx-3 mx-[2px] selection:inset-0 lg:my-4 my-1 lg:hover:rounded-xl lg:hover:shadow-2xl active:shadow-lg border-gray-200 rounded-xl lg:hover:border-white ease-linear duration-200">
